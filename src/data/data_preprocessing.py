...
def main():
    try:
        ...
        # Transform the data
        train_processed_data = preprocess_dataframe(train_data, 'title')
        train_processed_data = preprocess_dataframe(train_processed_data, 'text')
        test_processed_data = preprocess_dataframe(test_data, 'title')
        test_processed_data = preprocess_dataframe(test_processed_data, 'text')
